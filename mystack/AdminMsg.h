...
typedef struct tagAdminServerStartMsg:public SAdminMsg
{
	int m_nPort;

	tagAdminServerStartMsg():tagAdminMsg(ADMIN_SERVER_START_MSG){}
}SAdminServerStartMsg;
